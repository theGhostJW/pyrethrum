...
demo_test_stats = txtPretty $ testStatusCounts sampleStats
...
-- source doc can be generated by running >> runToFileAndConsole is stack repl
...
{"tag":"IterationLog","contents":{"tag":"Run","contents":{"tag":"StartInteraction"}}}
{"tag":"IterationLog","contents":{"tag":"Run","contents":{"tag":"Message","contents":"interact start"}}}
{"tag":"IterationLog","contents":{"tag":"Run","contents":{"tag":"Error","contents":{"tag":"FileSystemError","contents":["WriteFileError",{"ioe_description":"No such file or directory","ioe_location":"openFile","ioe_type":"NoSuchThing","ioe_filename":"R:\\Vids\\SystemDesign\\Wrong.txt","ioe_errno":"Just 2"}]}}}}
...
{"tag":"IterationLog","contents":{"tag":"Run","contents":{"tag":"StartInteraction"}}}
{"tag":"IterationLog","contents":{"tag":"Run","contents":{"tag":"Message","contents":"interact start"}}}
{"tag":"IterationLog","contents":{"tag":"Run","contents":{"tag":"Error","contents":{"tag":"EnsureError","contents":"Only even iids expected"}}}}
