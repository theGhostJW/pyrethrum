...
#### Template ####
[ Fixture
    { path = NodePath { module' = "0" , path = "Test" }
    , tests =
        [ TestItem
            { id = 0
            , title = "0.Test #0"
...
, OnceAfter
    { path = NodePath { module' = "2" , path = "OnceAfter" }
    , spec = Spec { delay = 0 , directive = Pass }
    , subNodes =
        [ OnceBefore
            { path = NodePath { module' = "2.0" , path = "OnceBefore" }
            , spec = Spec { delay = 0 , directive = Fail }
            , subNodes =
                [ OnceBefore
                    { path = NodePath { module' = "2.0.0" , path = "OnceBefore" }
                    , spec = Spec { delay = 0 , directive = Pass }
                    , subNodes =
                        [ Fixture
                            { path = NodePath { module' = "2.0.0.0" , path = "Test" }
                            , tests =
                                [ TestItem
                                    { id = 0
                                    , title = "2.0.0.0.Test #0"
                                    , spec = Spec { delay = 0 , directive = Pass }
                                    }
                                ]
                            }
...
, ThreadBefore
    { path = NodePath { module' = "3" , path = "ThreadBefore" }
    , threadSpec =
        PassProb
          { genStrategy = Preload
          , passPcnt = 25
    ...
    , subNodes =
        [ Fixture
            { path = NodePath { module' = "3.0" , path = "Test" }
            , tests =
                [ TestItem
                    { id = 0
                    , title = "3.0.Test #0"
...
#### Log ####
[ MkLog
    { lineInfo = MkLineInfo { threadId = 916 , idx = 0 }
    , event = StartExecution
    }
, MkLog
    { lineInfo = MkLineInfo { threadId = 1315 , idx = 0 }
    , event =
        Start
          { nodeType = Test
          , loc =
...
, MkLog
    { lineInfo = MkLineInfo { threadId = 1315 , idx = 1 }
    , event =
        End
          { nodeType = Test
          , loc =
...
, MkLog
    { lineInfo = MkLineInfo { threadId = 1315 , idx = 2 }
    , event =
        Start
          { nodeType = Test
          , loc =
...
, MkLog
    { lineInfo = MkLineInfo { threadId = 1315 , idx = 3 }
    , event =
        End
          { nodeType = Test
          , loc =
...
, MkLog
    { lineInfo = MkLineInfo { threadId = 1315 , idx = 4 }
    , event =
        Start
...
, MkLog
    { lineInfo = MkLineInfo { threadId = 1315 , idx = 5 }
    , event =
        Failure
          { nodeType = Hook Once Before
          , loc =
...
, MkLog
    { lineInfo = MkLineInfo { threadId = 1316 , idx = 0 }
    , event =
        Start
...
, MkLog
    { lineInfo = MkLineInfo { threadId = 1316 , idx = 1 }
    , event =
        Failure
          { nodeType = Hook Thread Before
          , loc =
...
, MkLog
    { lineInfo = MkLineInfo { threadId = 1316 , idx = 2 }
    , event =
        End
          { nodeType = Hook Thread Before
          , loc =
...
, MkLog
    { lineInfo = MkLineInfo { threadId = 1316 , idx = 3 }
    , event =
        ParentFailure
          { loc =
              ExePath
                { un =
                    [ TestPath { id = 0 , title = "3.0.Test #0" }
                    , NodePath { module' = "3.0" , path = "Test" }
                    , NodePath { module' = "3" , path = "ThreadBefore" }
                    ]
                }
          , nodeType = Test
          , failLoc =
              ExePath
                { un = [ NodePath { module' = "3" , path = "ThreadBefore" } ] }
          , failSuiteEvent = Hook Thread Before
          }
    }
, MkLog
    { lineInfo = MkLineInfo { threadId = 1315 , idx = 7 }
    , event =
        ParentFailure
          { loc =
              ExePath
...
, MkLog
    { lineInfo = MkLineInfo { threadId = 1315 , idx = 8 }
    , event =
        ParentFailure
          { loc =
              ExePath
                { un =
                    [ TestPath { id = 0 , title = "2.0.0.0.Test #0" }
                    , NodePath { module' = "2.0.0.0" , path = "Test" }
                    , NodePath { module' = "2.0.0" , path = "OnceBefore" }
                    , NodePath { module' = "2.0" , path = "OnceBefore" }
                    , NodePath { module' = "2" , path = "OnceAfter" }
                    ]
...
, MkLog
    { lineInfo = MkLineInfo { threadId = 1315 , idx = 9 }
    , event =
        Start
          { nodeType = Hook Once After
          , loc =
              ExePath
                { un = [ NodePath { module' = "2" , path = "OnceAfter" } ] }
          }
    }
, MkLog
    { lineInfo = MkLineInfo { threadId = 1315 , idx = 10 }
    , event =
        End
          { nodeType = Hook Once After
          , loc =
...
, MkLog
    { lineInfo = MkLineInfo { threadId = 916 , idx = 1 }
    , event = EndExecution
    }
]
=========
