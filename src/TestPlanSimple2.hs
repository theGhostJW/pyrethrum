...
import RunnerBase hiding (GenericTest(..))
...
type Runner e tc rc a effs = forall i as ds. GenericTest e tc rc i as ds effs -> Sem effs a
-- run 1 test 
-- in IO 
-- listing 
-- list known errors

-- introduce hooks / nesting 
-- hook pass state 
-- parallel 
-- pairwise 
