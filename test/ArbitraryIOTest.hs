...
-- RoughTest which is copied runs once on each iteration 6 iterations x 2 copies of test
unit_arbituary_io_is_logged_when_run_in_doc = chkMessageInstances "This is an arbitrary Put Line" 12 fullLogRun
