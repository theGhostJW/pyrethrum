...
module WeederLibCopy.Weeder (
  ...
  -- * extra exports added for use in WeeederDiscover
  annsContain,
  findIdentifiers,
  define,
  constructors,
...
import GHC.Iface.Ext.Types (
  ...
  HieArgs (HieArgs),
  HieFile (HieFile, hie_asts, hie_exports, hie_hs_file, hie_module, hie_types),
...
import GHC.Types.Avail (
  ...
  GreName (FieldGreName, NormalGreName),
 )
...
import GHC.Unit.Module (Module, ModuleName, moduleNameString, moduleStableString)
