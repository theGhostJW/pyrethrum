...
rawFile = fromList . B.lines $ toS 
  [r|{"tag":"BoundaryLog","contents":{"tag":"StartRun","runTitle":{"unRunTitle":"Sample RunConfig"},"runUtcOffsetMins":600,"runConfig":{"environment":"TST","country":"AU","runTitle":"Sample RunConfig","depth":"DeepRegression"}}}
