...
a2TestPrivList2 interpreter = runIOList $ runIOList <$> [
                                              RT.runPrintAllItems testInfoFull runConfig interpreter,
                                              DemoRoughTestSimple.runPrintAllItems testInfoFull runConfig interpreter
                                            ]
